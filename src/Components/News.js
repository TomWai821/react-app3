...
export class News extends Component{
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=f5f545c7bbb743e596b82a5db9abad91&page=1&pageSize=${this.props.pageSize}`;
